...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CTF59OSe.mjs");
...
var manifest = {
	"4cec520b81c06e0e5e3b60a990851e7e368b15d05d04bd4f01a12701f07d5cc8": {
		functionName: "getListing_createServerFn_handler",
		importer: () => import("./listings-D-cdLick.mjs")
	},
	"dbba1fd22c0136f0cd09668c1705b57515fbeaa836d24b04e39e32b00e1b9826": {
		functionName: "createListing_createServerFn_handler",
		importer: () => import("./listings-D-cdLick.mjs")
	},
	"f1208e5350025071c264cbd811b2a379c4d50678e59e5c6aacc13c1d085424c4": {
		functionName: "listFeatured_createServerFn_handler",
		importer: () => import("./listings-D-cdLick.mjs")
	},
	"f24e3e55b8843be3714011804beabbe76ca57c09c0fc5a685ef4a6ef981305e3": {
		functionName: "listListings_createServerFn_handler",
		importer: () => import("./listings-D-cdLick.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-zU6nJH54.mjs").then((n) => n.t),
